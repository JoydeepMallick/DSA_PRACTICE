...
struct node* appendinfront(struct node *head){
    int n,d;
    struct node *newnode;
    printf("\n\nHow many elements to enter in front : ");
    scanf("%d",&n);
    while(n--){
...
struct node* pushback(struct node *head){
    int n,d;
    struct node *newnode,*ptr;
    printf("\n\nHow many elements to enter at the end: ");
    scanf("%d",&n);
