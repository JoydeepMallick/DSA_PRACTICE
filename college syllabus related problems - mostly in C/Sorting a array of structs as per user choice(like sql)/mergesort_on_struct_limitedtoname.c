...
#include <string.h>
/*
 * this code is generated by chatpt
 *
 * here only one problem is that names must be single word, dont include name by multiple sizes.
 */
...
int main() {
  ...
  for (int i = 0; i < n; i++) {
    ...
    printf("Enter name(only single word permitted) for student %d: ", i + 1);
    scanf("%s", arr[i].name);//limited to a single word name 
